...
.save{ background: #0f172a; border:none; cursor:pointer; }
...
<tr>
    ...
    <td>
        <div class="action-box">
            ...
            <a class="btn delete" href="users.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('Delete?')">Delete</a>
...
<input type="number" id="amount" name="amount" placeholder="Delivery Amount" oninput="calcGST()" required><br><br>
